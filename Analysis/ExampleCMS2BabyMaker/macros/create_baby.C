...
)
{
    ...
    if (sample_name == "dytt"   ) nevts_corr = (27137253.0/static_cast<double>(chain.GetEntries()));
    ...
    if (sample_name == "ww2l2nu") nevts_corr = (1933235.0 /static_cast<double>(chain.GetEntries()));
    if (sample_name == "wz2l2q" ) nevts_corr = (2937874.0 /static_cast<double>(chain.GetEntries()));
    if (sample_name == "wz3lnu" ) nevts_corr = (2017979.0 /static_cast<double>(chain.GetEntries()));
